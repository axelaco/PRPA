...
program_naive:
	gcc -fopenmp -o eigen_program -DNAIVE eigen_program.c math.c -lm -g3 -llapack -lblas
program_cuda:
	nvcc -lcublas -lcusolver  cuda_kernel_func.cu math_cuda.c -llapack eigen_program_cuda.c -o eigen_program_cuda -g -G
program_cuda_v2:
		nvcc -lcublas -lcusolver  cuda_kernel_func.cu math_cuda_v2.c -llapack eigen_program_cuda_v2.c -o eigen_program_cuda_v2 -g
program_cpx_mkl:
