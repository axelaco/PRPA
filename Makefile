...
program_cuda:
	nvcc -lcublas -lcusolver  cuda_kernel_func.cu math_cuda.c -llapack eigen_program_cuda.c -o eigen_program_cuda -g
program_cpx_mkl:
...
program_test_cuda_v2:
	nvcc -lcublas -lcusolver  cuda_kernel_func.cu math_cuda_v2.c  test_cuda_v2_func.c -o test_cuda_v2_func -g
